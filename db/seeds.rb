...
#
# recipe2 = user.created_recipes.create(name: "Homemade Gelato", prep_time: 60, cook_time: 120, category: "Frozen", instructions: "In a medium saucepan, mix milk and cream. Warm until foam forms around the edges. Remove from heat.
...
#
# recipe3 = user.created_recipes.create(name: "Chocolate-Covered Oreo Cookie Cake", prep_time: 20, cook_time: 60, category: "Cake", instructions: "Heat oven to 350 degrees F.
...
#
recipe4 = user.created_recipes.create(name: "White Chocolate Pound Cake", prep_time: 20, cook_time: 60, category: "Cake", instructions: "Preheat oven to 350 degrees (175 degrees C). Grease one 10 inch bundt pan. Sprinkle 2 tablespoons of white sugar in the bundt pan.
...
Let cake cool in pan for 10 minutes then remove from pan and let cool on a wire rack completely. Once cool place cake on a serving dish and drizzle with melted white and semisweet chocolate. Garnish with strawberries, if desired.",
  ingredients_attributes:
    {0 => {name: "white sugar", quantity: "2 tablespoons"}}
    {1 => {name: "white chocolate", quantity: "8 squares"}}
    {2 => {name: "butter", quantity: "1 cup"}}
    {3 => {name: "eggs", quantity: "2"}}
    {4 => {name: "vanilla extract", quantity: "2 teaspoons"}}
    {5 => {name: "almond extract", quantity: "1/2 teaspoon"}}
    {6 => {name: "flour", quantity: "3 cups"}})
# recipe4.ingredients = [
...
#
# recipe5 = user.created_recipes.create(name: "Chewy Sugar Cookies", prep_time: 10, cook_time: 15, category: "Cookie", instructions: "Preheat oven to 350 degrees F (175 degrees C). In a medium bowl, stir together the flour, baking soda, and salt; set aside.
